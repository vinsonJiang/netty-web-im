package io.vinson.im.core.redis;
...
public final class RedissionManager {
    ...
    public RedissonClient connect(RedisConfig redisConfig) throws Exception {
        if(redisson != null) {
        ...
        Codec codec=(Codec) Class.forName(redisConfig.getCodec()).newInstance();
